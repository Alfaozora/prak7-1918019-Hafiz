...
public class MainRead extends AppCompatActivity implements AdapterView.OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent, View view, int i, long l) {
            ...
            Intent goUpdet = new Intent(MainRead.this, MainUpdet.class);
            goUpdet.putExtra("Iid", Sid);
            goUpdet.putExtra("Inama", Snama);
            goUpdet.putExtra("Ikelas", Skelas);
            startActivity(goUpdet);
        }
        @Override
