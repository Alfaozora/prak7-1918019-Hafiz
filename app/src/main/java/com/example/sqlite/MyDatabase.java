...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_MAHASISWA = "CREATETABLE" + tb_mahasiswa +"(" + tb_mahasiswa_id + " INTEGER PRIMARY KEY ," + tb_mahasiswa_nama + " TEXT ," + tb_mahasiswa_kelas + " TEXT " + ")";
